            ...
            <Breadcrumb>
              <BreadcrumbList>
                <BreadcrumbItem className="hidden md:block">
                  <BreadcrumbLink href="/compagny-dashboard/profile">
                ...
                <BreadcrumbItem>
                  <BreadcrumbPage className="text-2xl font-bold text-gray-900 mb-2">Personnalisez votre profil entreprise</BreadcrumbPage>
                </BreadcrumbItem>
              </BreadcrumbList>
            </Breadcrumb>
          </div>
